// WINEL7MDlg.cpp : implementation file
//

#include "stdafx.h"
#include "WINEL7M.h"
#include "WINEL7MDlg.h"
#include "Code7.h"
...
// CWINEL7MDlg dialog
CWINEL7MDlg::CWINEL7MDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CWINEL7MDlg::IDD, pParent)
{
...
void CWINEL7MDlg::DoDataExchange(CDataExchange* pDX)
{
   CDialog::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CWINEL7MDlg, CDialog)
   ON_WM_PAINT()
   ON_WM_QUERYDRAGICON()
   //}}AFX_MSG_MAP
   ON_CBN_SELCHANGE(IDC_COMBO1, &CWINEL7MDlg::OnCbnSelchangeCombo1)
   ON_BN_CLICKED(IDC_CHECK1, &CWINEL7MDlg::OnBnClickedCheck1)
   ON_BN_CLICKED(IDC_CHECK2, &CWINEL7MDlg::OnBnClickedCheck2)
   ON_BN_CLICKED(IDC_CHECK3, &CWINEL7MDlg::OnBnClickedCheck3)
   ON_WM_NCLBUTTONDOWN()
   ON_WM_MOUSEMOVE()
   ON_WM_LBUTTONDOWN()
   ON_WM_KEYDOWN()
   ON_WM_KEYDOWN()
   ON_WM_LBUTTONDBLCLK()
   ON_BN_CLICKED(IDC_CHECK4, &CWINEL7MDlg::OnBnClickedCheck4)
END_MESSAGE_MAP()

// CWINEL7MDlg message handlers
BOOL CWINEL7MDlg::OnInitDialog()
{
...
HCURSOR CWINEL7MDlg::OnQueryDragIcon()
{
   return static_cast<HCURSOR>(m_hIcon);
}

void CWINEL7MDlg::Draw2LEDs()
{
   CClientDC dc(this);
...
int CWINEL7MDlg::DescribeKeyState() 
{
...
void CWINEL7MDlg::OnNcLButtonDown(UINT nHitTest, CPoint point)
{
...
void CWINEL7MDlg::OnMouseMove(UINT nFlags, CPoint point)
{
// TODO: Add your message handler code here and/or call default
   SetActiveWindow();
...
void CWINEL7MDlg::processKeyDaunCommon(int buttonIndex)
{
...
void CWINEL7MDlg::syncCheckBoxes(void)
{
   //int state = 0;
   short ks;
...
void CWINEL7MDlg::OnKeyUp(UINT nChar, UINT nRepCnt, UINT nFlags)
{
   syncCheckBoxes();
   //CDialogEx::OnKeyDown(nChar, nRepCnt, nFlags);
}
void CWINEL7MDlg::OnLButtonDblClk(UINT nFlags, CPoint point)
{
   // TODO: Add your message handler code here and/or call default
...
void CWINEL7MDlg::OnLButtonDown(UINT nFlags, CPoint point)
{
   // TODO: Add your message handler code here and/or call default
...
void CWINEL7MDlg::OnCbnSelchangeCombo1()
{
...
void CWINEL7MDlg::OnBnClickedCheck1()
{
   // TODO: Add your control notification handler code here
   mkc16I._flag123AaSftCtrl |= 1;
   CButton* chkBxP = (CButton*)GetDlgItem(IDC_CHECK1);
...
void CWINEL7MDlg::OnBnClickedCheck2()
{
   // TODO: Add your control notification handler code here
   mkc16I._flag123AaSftCtrl |=2;
   CButton* chkBxP = (CButton*)GetDlgItem(IDC_CHECK2);
...
void CWINEL7MDlg::OnBnClickedCheck3()
{
   // TODO: Add your control notification handler code here
   mkc16I._flag123AaSftCtrl |=4;
...
void CWINEL7MDlg::OnBnClickedCheck4()
{
   // TODO: Add your control notification handler code here
   mkc16I._flag123AaSftCtrl |=8;
