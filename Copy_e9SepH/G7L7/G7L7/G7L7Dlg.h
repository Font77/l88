...
// CG7L7Dlg dialog
class CG7L7Dlg : public CDialog
{
// Construction
public:
	CG7L7Dlg(CWnd* pParent = NULL);	// standard constructor

// Dialog Data
	enum { IDD = IDD_G7L7_DIALOG };
...
public:
   ...
   afx_msg void OnShowWindow(BOOL bShow, UINT nStatus);
	afx_msg void OnShowG7();
   afx_msg void OnShowL7();
