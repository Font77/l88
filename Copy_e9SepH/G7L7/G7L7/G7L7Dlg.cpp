// G7L7Dlg.cpp : implementation file
//
...
// CG7L7Dlg dialog
CG7L7Dlg::CG7L7Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CG7L7Dlg::IDD, pParent)
{
...
void CG7L7Dlg::DoDataExchange(CDataExchange* pDX)
{
   CDialog::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CG7L7Dlg, CDialog)
   ON_WM_PAINT()
   ON_WM_QUERYDRAGICON()
   //}}AFX_MSG_MAP
   ON_CBN_SELCHANGE(IDC_COMBO1, &CG7L7Dlg::OnCbnSelchangeCombo1)
   ON_BN_CLICKED(IDC_CHECK1, &CG7L7Dlg::OnBnClickedCheck1)
   ON_BN_CLICKED(IDC_CHECK2, &CG7L7Dlg::OnBnClickedCheck2)
   ON_BN_CLICKED(IDC_CHECK3, &CG7L7Dlg::OnBnClickedCheck3)
   ON_WM_NCLBUTTONDOWN()
   ON_WM_MOUSEMOVE()
   ON_WM_LBUTTONDOWN()
   ON_WM_LBUTTONDBLCLK()
   ON_BN_CLICKED(IDC_CHECK4, &CG7L7Dlg::OnBnClickedCheck4)
   ON_COMMAND(IDM_EXIT, OnExit)
	ON_COMMAND(IDM_SHOW_G7, OnShowG7)
   ON_COMMAND(IDM_SHOW_L7, OnShowL7)
	ON_UPDATE_COMMAND_UI(IDM_SHOW_G7, OnUpdateShowKeyboard)
...
// CG7L7Dlg message handlers
BOOL CG7L7Dlg::OnInitDialog()
{
   ...
   //syncNUM123();
   const TCHAR *items[] = 
   { L"English", L"हिनदी", L"বাংলা", L"ਪੰਜਾਬੀ", L"ગુજરાતી", L"ଓଡ଼ିଆ", L"தமிழ்", L"తెలుగు", L"ಕನ್ನಡ", L"മലയാളം" }	;
   CComboBox* p_cbox = (CComboBox*)GetDlgItem(IDC_COMBO1);
   for(int i=0 ; i<10; i++) { p_cbox->AddString(items[i]); }
   p_cbox->SetCurSel(0);
   VERIFY(cSystray.Create(NULL, WM_ICON_NOTIFY, _T("G7L7"), m_hIcon, IDR_MENU1));
...
HCURSOR CG7L7Dlg::OnQueryDragIcon()
{
   return static_cast<HCURSOR>(m_hIcon);
}
void CG7L7Dlg::DrawKeyboard(void)
{
   CClientDC dc(this);
   CBitmap bitmap; 
   CDC dcMemory;
   // Sequence is important
   dc.MoveTo(0,32); dc.LineTo(256,32);dc.MoveTo(0,0);
   bitmap.LoadBitmap(IDB_BITMAP1);
   dcMemory.CreateCompatibleDC(&dc);
   dcMemory.SelectObject(&bitmap);
   dc.BitBlt(2, 34, 252, 133, &dcMemory, 0, 0, SRCCOPY);
}
void CG7L7Dlg::Draw2LEDs()
{
   CClientDC dc(this);
   CBrush brushBlack(RGB(0, 0, 0)); CBrush brushRed(RGB(255, 0, 0));
   CBrush brushWhite(RGB(255, 255, 255)); CBrush brushGreen(RGB(0, 255, 0));
   ////
   for(int i=0;i<8;i++)
   {
...
void CG7L7Dlg::OnNcLButtonDown(UINT nHitTest, CPoint point)
{
...
void CG7L7Dlg::OnMouseMove(UINT nFlags, CPoint point)
{
// TODO: Add your message handler code here and/or call default
   SetActiveWindow();
...
void CG7L7Dlg::processKeyDaunCommon(int buttonIndex)
{
...
void CG7L7Dlg::syncCheckBoxes(void)
{
   //int state = 0;
   short ks;
...
void CG7L7Dlg::OnKeyUp(UINT nChar, UINT nRepCnt, UINT nFlags)
{
   syncCheckBoxes();
   //CDialogEx::OnKeyDown(nChar, nRepCnt, nFlags);
}
void CG7L7Dlg::OnLButtonDblClk(UINT nFlags, CPoint point)
{
   // TODO: Add your message handler code here and/or call default
...
void CG7L7Dlg::OnLButtonDown(UINT nFlags, CPoint point)
{
   // TODO: Add your message handler code here and/or call default
...
void CG7L7Dlg::OnCbnSelchangeCombo1()
{
...
void CG7L7Dlg::OnBnClickedCheck1()
{
   // TODO: Add your control notification handler code here
   mkc16I._flag123AaSftCtrl |= 1;
   CButton* chkBxP = (CButton*)GetDlgItem(IDC_CHECK1);
...
void CG7L7Dlg::OnBnClickedCheck2()
{
   // TODO: Add your control notification handler code here
   mkc16I._flag123AaSftCtrl |=2;
   CButton* chkBxP = (CButton*)GetDlgItem(IDC_CHECK2);
...
void CG7L7Dlg::OnBnClickedCheck3()
{
   // TODO: Add your control notification handler code here
   mkc16I._flag123AaSftCtrl |=4;
...
void CG7L7Dlg::OnBnClickedCheck4()
{
   // TODO: Add your control notification handler code here
   mkc16I._flag123AaSftCtrl |=8;
...
void CG7L7Dlg::OnShowWindow(BOOL bShow, UINT nStatus)
{
   CDialog::OnShowWindow(bShow, nStatus);
   // TODO: Add your message handler code here
	if(bShow) { cSystray.SetMenuDefaultItem(IDM_HIDE_KEYBOARD, FALSE); 	}
	else 	{ cSystray.SetMenuDefaultItem(IDM_SHOW_G7, FALSE); 	}
}
void CG7L7Dlg::OnOK()
{
...
void CG7L7Dlg::OnShowG7() {
   isG7 = true;
   ShowWindow(SW_SHOW);
}
void CG7L7Dlg::OnShowL7() {
   isG7 = false;
   ShowWindow(SW_SHOW);
}
void CG7L7Dlg::OnUpdateShowKeyboard(CCmdUI* pCmdUI) {	pCmdUI->Enable(!IsWindowVisible()); }
void CG7L7Dlg::OnHideKeyboard()
{
	int state = DescribeKeyState();
	if(state & 0x01) keybd_event(VK_CAPITAL,0,KEYEVENTF_KEYUP,0);
	if(state & 0x02) keybd_event(VK_SHIFT,0,KEYEVENTF_KEYUP,0);
...
void CG7L7Dlg::OnUpdateHideKeyboard(CCmdUI* pCmdUI) {	pCmdUI->Enable(IsWindowVisible()); }
void CG7L7Dlg::OnExit() 
{
	int state = DescribeKeyState();
	if(state & 0x01) keybd_event(VK_CAPITAL,0,KEYEVENTF_KEYUP,0);
	if(state & 0x02) keybd_event(VK_SHIFT,0,KEYEVENTF_KEYUP,0);
